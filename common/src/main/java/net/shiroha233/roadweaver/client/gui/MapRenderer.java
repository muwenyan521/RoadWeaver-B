...
public class MapRenderer {
    ...
    public void drawStructures(GuiGraphics ctx, List<net.shiroha233.roadweaver.helpers.Records.StructureInfo> structureInfos,
        ...
        for (net.shiroha233.roadweaver.helpers.Records.StructureInfo info : structureInfos) {
