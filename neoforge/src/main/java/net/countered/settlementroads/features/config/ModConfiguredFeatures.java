...
public class ModConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> ROAD_FEATURE_KEY =
            ResourceKey.create(Registries.CONFIGURED_FEATURE,
                    ResourceLocation.fromNamespaceAndPath(SettlementRoads.MOD_ID, "road_feature"));

    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context){
        LOGGER.info("Bootstrap ConfiguredFeature");
        context.register(ROAD_FEATURE_KEY,
                new ConfiguredFeature<>(RoadFeatureRegistry.ROAD_FEATURE.get(),
